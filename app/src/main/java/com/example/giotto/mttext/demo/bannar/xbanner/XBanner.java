package com.example.giotto.mttext.demo.bannar.xbanner;
...
import com.example.giotto.mttext.demo.bannar.xbanner.entity.SimpleBannerInfo;
import com.example.giotto.mttext.demo.bannar.xbanner.transformers.BasePageTransformer;
import com.example.giotto.mttext.demo.bannar.xbanner.transformers.Transformer;
...
public class XBanner extends RelativeLayout implements XBannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private void init(Context context) {
        ...
        height = XBannerUtils.sp2px(context, 161);
    ...
    private void initView() {
        ...
        /*设置指示器背景容器*/
        LinearLayout pointContainerRl = new LinearLayout(getContext());
        pointContainerRl.setOrientation(LinearLayout.VERTICAL);
        pointContainerRl.setGravity(Gravity.CENTER_HORIZONTAL);
...
//        pointContainerRl.setPadding(mPointContainerLeftRightPadding, mPointTopBottomPading, mPointContainerLeftRightPadding, mPointTopBottomPading);
        ...
        mPointContainerLp.addRule(RelativeLayout.BELOW, R.id.xbanner_viewpagerId);
        if (mIsClipChildrenMode) {
    ...
    private void setBannerPlaceholderDrawable() {
        if (mPlaceholderDrawableResId != NO_PLACE_HOLDER && mPlaceholderImg == null) {
            ...
            mPlaceholderImg.setScaleType(ImageView.ScaleType.CENTER_CROP);
    ...
    private void initViewPager() {
        ...
        mViewPager.setId(R.id.xbanner_viewpagerId);
        ...
        LayoutParams layoutParams = new LayoutParams(RMP, height);
