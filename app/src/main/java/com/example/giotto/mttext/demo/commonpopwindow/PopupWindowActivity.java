...
import com.example.giotto.mttext.demo.utils.DeviceUtils;
import com.example.giotto.mttext.demo.utils.MyUtils;

/**
 * @Author yly
 * @Data 2018/5/10 11:04
...
//        popupWindow.showAtLocation(findViewById(android.R.id.content), Gravity.NO_GRAVITY, positions[0], positions[1] - popupWindow.getHeight());
    ...
    public void showReminder(View view) {
        ...
        popupWindow = new CommonPopupWindow.Builder(this)
                ...
                .setWidthAndHeight(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT)
                .create();
        popupWindow.showAsDropDown(view, (int) (-popupWindow.getWidth() + DeviceUtils.dp2px(this, 20)), -(popupWindow.getHeight() + view.getMeasuredHeight()));
    }
        ...
        switch (layoutResId) {
            case R.layout.popup_down:
                ...
                mAdapter.setOnItemClickListener(new MyOnclickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        MyUtils.showToast(PopupWindowActivity.this, "position is " + position);
                        if (popupWindow != null) {
                            popupWindow.dismiss();
                        }
                    }
            ...
            case R.layout.popup_up:
                ...
                btn_take_photo.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        MyUtils.showToast(PopupWindowActivity.this, "拍照");
                        if (popupWindow != null) {
                            popupWindow.dismiss();
                        }
                    }
                ...
                btn_select_photo.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        MyUtils.showToast(PopupWindowActivity.this, "相册选取");
                        if (popupWindow != null) {
                            popupWindow.dismiss();
                        }
                    }
            ...
            case R.layout.popup_left_or_right:
                ...
                tv_like.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        MyUtils.showToast(PopupWindowActivity.this, "赞一个");
                        popupWindow.dismiss();
                    }
                });
                tv_hate.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        MyUtils.showToast(PopupWindowActivity.this, "踩一下");
                        popupWindow.dismiss();
                    }
                });
                break;
