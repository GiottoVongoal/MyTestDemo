package com.example.giotto.mttext.demo.foodmenu.adapter;
...
import com.example.giotto.mttext.demo.foodmenu.FoodInfoActivity;
...
public class TestSectionedAdapter extends SectionedBaseAdapter {
    ...
    public View getItemView(final int section, final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.mainitem_layout = (RelativeLayout) convertView.findViewById(R.id.mainitem_layout);
        ...
        viewHolder.name.setText(product.getGoods() + "\t" + product.getId());
        ...
        viewHolder.mainitem_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("name", product.getGoods());
